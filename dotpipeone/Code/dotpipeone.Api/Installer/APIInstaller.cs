...
using ElmahCore.Mvc;
using ElmahCore;
using dotpipeone.Api.Filters;
using dotpipeone.BusinessServices.Installer;

namespace dotpipeone.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotpipeone API", Version = version + "-" + branch});
            });
